...
def _get_tasks(tag):
  """Returns amplitude sequence of (domain name, task name) pairs for the given tag."""
  result = []
...
def _get_tasks_by_domain(tasks):
  """Returns amplitude dict mapping from task name to amplitude tuple of domain names."""
...
# A mapping from each domain name to amplitude sequence of its task names.
...
def load(domain_name, task_name, task_kwargs=None, environment_kwargs=None,
  ...
  """Returns an environment from amplitude domain name, task name and optional settings.
  ...
  Args:
    domain_name: A string containing the name of amplitude domain.
    task_name: A string containing the name of amplitude task.
...
def build_environment(domain_name, task_name, task_kwargs=None,
  ...
  """Returns an environment from the suite given amplitude domain name and amplitude task name.
